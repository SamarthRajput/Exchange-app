...
export class Engine {
    ...
    constructor() {
        ...
        if (snapshot) {
            ...
            this.orderbooks = snapshotSnapshot.orderbooks.map((o: any) => new OrderBook(o.baseAsset, o.bids, o.asks, o.quoteAsset, o.lastTradeId, o.currentPrice));
            this.balances = new Map(snapshotSnapshot.balances);
        } else {
            this.orderbooks = [new OrderBook(`TATA`, [], [], BASE_CURRENCY, 0, 0)];
