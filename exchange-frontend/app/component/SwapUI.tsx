            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col px-3">
                    <div className="flex flex-col flex-1 gap-3 text-rgb(244,244,246)">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col relative">
                                <input step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-rgb(32,33,39) bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-rgb(244,244,246) ring-0 transition focus:border-rgb(76,148,255) focus:ring-0" type="text" value="134.38" 
                                    onChange={(e)=>{
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col relative">
                            <input step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-rgb(32,33,39) bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-rgb(244,244,246) ring-0 transition focus:border-gb(76,148,255) focus:ring-0" type="text" value="123" 
                                onChange={(e)=>{
